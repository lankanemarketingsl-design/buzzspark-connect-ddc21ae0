...
export const graphicDesignServices: GraphicDesignServiceData[] = [
  ...
  },
  {
    ...
    h1: "Package Design Sri Lanka – Custom Product Packaging Design Services",
    intro: [
      "Product packaging is often the first physical touchpoint between your brand and customers. Great packaging design protects your product, communicates your brand story, and creates an unboxing experience that customers remember.",
      "Buzz Connect offers creative product packaging design services for businesses across Sri Lanka, from food and beverage packaging to cosmetics, retail products, and gift boxes.",
    ],
    benefits: [
      "Creative designs that enhance brand perception",
      "Structural and visual packaging design",
      "Food, cosmetics & retail packaging expertise",
      "3D mockups for visualization",
      "Die-cut templates and print specifications",
      "Eco-friendly packaging design options",
    ],
    process: [
      { step: "Brief", desc: "Share product specs, dimensions, and brand guidelines" },
      { step: "Concept", desc: "We create packaging concepts with 3D mockups" },
      { step: "Refine", desc: "Iterate on design, structure, and print details" },
      { step: "Deliver", desc: "Production-ready files with die-cut templates" },
    ],
    faqs: [
      { q: "What types of packaging do you design?", a: "We design boxes, bags, pouches, bottles, tubes, cartons, and custom packaging for any product type." },
      { q: "Do you provide 3D mockups?", a: "Yes, we create realistic 3D mockups so you can visualize the final packaging before production." },
      { q: "Can you design eco-friendly packaging?", a: "Yes, we specialize in sustainable packaging design using recyclable and biodegradable materials." },
    ],
  },
];
