    ...
    >
      ...
      <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="mb-16 p-8 rounded-2xl gradient-hero text-primary-foreground">
        ...
        <p className="text-primary-foreground/80 mb-6">
          Get your hotel listed and promoted in Findit.lk's <strong>Hotels & Accommodation</strong> and <strong>Travel & Tourism</strong> categories for continuous visibility to high-intent travelers.
        </p>
