    ...
    >
      ...
      <IndustryMarketingSection
        ...
        industries={[
          ...
          { emoji: "🎓", title: "Education SMS Marketing Sri Lanka – Drive Student Inquiries", campaigns: ["Course intake alerts", "Deadline reminders for registration", "Open day / seminar invitations"], results: ["Immediate student inquiries", "Faster enrollment decisions", "Higher response rates than email"], link: "/education-marketing", linkText: "education marketing" },
          { emoji: "🏠", title: "Real Estate SMS Marketing Sri Lanka – Generate Property Leads", campaigns: ["Property launch alerts", "Price drop & limited-unit promotions", "Site visit invitations"], results: ["Direct buyer inquiries", "Faster conversions", "High-intent leads"], link: "/real-estate-marketing", linkText: "real estate marketing" },
          ...
          { emoji: "🍽️", title: "Restaurant SMS Marketing Sri Lanka – Increase Daily Orders", campaigns: ["Lunch / dinner deals", "Daily specials & promotions", "Reservation confirmations"], results: ["Increased foot traffic", "More repeat customers", "Higher daily revenue"], link: null, linkText: "" },
          { emoji: "💼", title: "Recruitment SMS Marketing Sri Lanka – Hire Faster", campaigns: ["Job vacancy alerts", "Interview reminders", "Bulk hiring campaigns"], results: ["Faster applicant response", "More qualified candidates", "Reduced hiring time"], link: null, linkText: "" },
          ...
          { emoji: "🏦", title: "Finance & Insurance SMS Marketing – Generate Leads", campaigns: ["Loan & leasing offers", "Payment reminders", "Investment promotions"], results: ["High-quality leads", "Faster decision-making", "Strong ROI"], link: null, linkText: "" },
          { emoji: "👗", title: "Fashion & Clothing SMS Marketing – Drive Sales", campaigns: ["New arrivals & collections", "Seasonal discounts", "Exclusive VIP offers"], results: ["Increased store visits", "Higher sales", "Strong brand recall"], link: null, linkText: "" },
          { emoji: "🎉", title: "Event SMS Marketing Sri Lanka – Maximize Attendance", campaigns: ["Event announcements", "Ticket promotions", "Reminder alerts"], results: ["Higher attendance rates", "Faster ticket sales", "Better engagement"], link: null, linkText: "" },
          ...
          { emoji: "🧳", title: "Travel & Tourism SMS Marketing – Promote Packages", campaigns: ["Tour deals & holiday packages", "Last-minute travel offers", "Booking confirmations"], results: ["Increased bookings", "Faster inquiries", "Higher campaign ROI"], link: null, linkText: "" },
        ]}
