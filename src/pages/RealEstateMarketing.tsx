  ...
  return (
    ...
    >
      ...
      <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="mb-16 p-8 rounded-2xl gradient-hero text-primary-foreground">
        ...
        <p className="text-primary-foreground/80 mb-6">Get your properties promoted in Findit.lk's <strong>Real Estate</strong> category for continuous visibility to active property seekers.</p>
